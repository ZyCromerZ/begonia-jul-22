...
#define SEG_GPU_DVFS_VOLT0		(87500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT1		(86875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT2		(86250 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT3		(85625 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT4		(85000 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT5		(84375 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT6		(83750 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT7		(83125 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT8		(82500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT9		(81875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT10		(81250 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT11		(80625 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT12		(80000 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT13		(79375 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT14		(78750 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT15		(78125 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT16		(77500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT17		(76875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT18		(76250 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT19		(75625 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT20		(75000 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT21		(74375 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT22		(73750 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT23		(73125 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT24		(72500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT25		(71875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT26		(71250 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT27		(70625 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT28		(70000 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT29		(69375 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT30		(68750 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT31		(68125 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT32		(67500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT33		(66875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT34		(66250 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT35		(65625 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT36		(65000 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT37		(64375 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT38		(63750 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT39		(63125 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT40		(62500 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT41		(61875 - 3000)		/* mV x 100 (and -30mV)*/
#define SEG_GPU_DVFS_VOLT42		(61250 - 3000)		/* mV x 100 (and -30mV)*/
